<%@ Page Language="C#" MasterPageFile="~/client1/MasterPage.master" AutoEventWireup="true" CodeFile="Sales_report.aspx.cs" Inherits="client1_report" Title="Untitled Page" %>
        ...
        <tr>
            <td colspan="4" style="text-align: left" width="100%">
                <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" 
                    GridLines="None" AutoGenerateColumns="False" Width="460px">

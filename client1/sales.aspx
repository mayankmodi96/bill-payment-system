<%@ Page Language="C#" MasterPageFile="~/client1/MasterPage.master" AutoEventWireup="true" CodeFile="sales.aspx.cs" Inherits="client1_sales" Title="Untitled Page" %>
            ...
            <td colspan="2" style="text-align: right; width: 100%" width="50%">
                <table style="width: 100%">
                    <tr>
                        ...
                        <td style="text-align: right; height: 13px;" width="16%">
                            Bill date:</td>
                        <td style="text-align: left; height: 13px;" width="35%">
                            <asp:TextBox ID="TextBox6" runat="server" Height="18px" Width="95px"></asp:TextBox>
                            <asp:ImageButton ID="ImageButton1" runat="server" Height="26px" 
                                ImageUrl="../icon/images_2.jpeg" onclick="ImageButton1_Click" 
                                Width="32px" />
                        </td>
                    </tr>
                </table>
                ...
                <span style="color: #6666FF"><b>purchase Item details:</b></span><table style="width: 100%">
                    ...
                    <tr>
                        <td colspan="5" width="100%" style="text-align: center">
                            <asp:Button ID="Button1" runat="server" Height="26px" Text="ADD" Width="58px" onclick="Button1_Click" 
                                />
                        </td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" width="100%">
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                                    ...
                                                    CellPadding="3" Width="475px" Height="83px">
                                            ...
                                            <tr>
                                                <td style="text-align: center; width: 100%;" width="50%">
                                                    ...
                                                    <asp:Button ID="Button2" runat="server" Height="26px" Text="Submit &amp; Report" 
                                                        Width="119px" onclick="Button2_Click"  />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
